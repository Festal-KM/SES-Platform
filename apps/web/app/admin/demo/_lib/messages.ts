...
export function adminDemoMessages(): AdminDemoScreenMessages {
  return {
    ...
    reset: {
      section: t('admin.demo.section.reset'),
      lead: t('admin.demo.reset.lead'),
      targets: t('admin.demo.reset.targets'),
      submit: t('admin.demo.reset.submit'),
      confirmTitle: t('admin.demo.reset.confirm.title'),
      confirmLead: t('admin.demo.reset.confirm.lead'),
      confirmEnvironment: t('admin.demo.reset.confirm.environment'),
      confirmEnvInput: t('admin.demo.reset.confirm.envInput'),
      confirmTenantInput: t('admin.demo.reset.confirm.tenantInput'),
      confirmMismatch: t('admin.demo.reset.confirm.mismatch'),
      confirmSubmit: t('admin.demo.reset.confirm.submit'),
      confirmBack: t('admin.demo.reset.confirm.back'),
      submitting: t('admin.demo.reset.submitting'),
      done: t('admin.demo.reset.done'),
      nothingToReset: t('admin.demo.reset.nothingToReset'),
      failed: t('admin.demo.reset.failed'),
      retry: t('admin.demo.reset.retry'),
    },
    scenarios: {
