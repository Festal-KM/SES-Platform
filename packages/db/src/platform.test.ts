...
describe('列挙の網羅（docs/05 §5.2 / §5.5）', () => {
  it('🔴 読み取り可能なモデルは 53 件ちょうど（migration 20260904010000 §2 + 20260917000000〔engineer_careers。T-09-12〕の GRANT と 1 対 1）', () => {
    expect(PLATFORM_READABLE_MODELS).toHaveLength(53);
    expect(new Set(PLATFORM_READABLE_MODELS).size).toBe(53);
  });
