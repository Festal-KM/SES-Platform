...
describe('列挙の網羅（docs/05 §5.2 / §5.5）', () => {
  it('🔴 読み取り可能なモデルは 56 件ちょうど（migration 20260904010000 §2 + 20260917000000〔engineer_careers。T-09-12〕+ 20260919000000〔usage_measurement_findings。T-10-02〕+ 20260920000000〔usage_limit_states。T-10-03〕+ 20260924000000〔tenant_quota_overrides。T-11-02〕の GRANT と 1 対 1）', () => {
    expect(PLATFORM_READABLE_MODELS).toHaveLength(56);
    expect(new Set(PLATFORM_READABLE_MODELS).size).toBe(56);
  });
