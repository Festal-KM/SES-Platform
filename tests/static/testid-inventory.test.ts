...
const FROZEN_EXACT: readonly string[] = [
  ...
  // ✅ T-12-16: `engineer-detail-proposals-coming-soon`（T-05-02 の暫定表示）は `S-006` セクション 4（提案履歴）・5（凍結情報との差分）の
  //    実装で**画面から廃止**したため凍結を解いた（プレースホルダの実装置換。E2E / render テストに参照は無かった）。
  //    代わりにセクション 4・5 の testid を足す（動的なものは `FROZEN_PREFIXES`）。
  'engineer-detail-proposals-empty',
  'engineer-detail-proposals-table',
  ...
  // ✅ T-11-11: `S-015` を 1 表 + 検索 3 条件 + 共有状態フィルタ + カーソルページングに改めた（`docs/04` 改訂 12）。
  //    旧 2 表の `engineer-share-shared(-table|-empty)` / `engineer-share-not-shared(-table|-empty)` は**フィルタの母集団を示す
  //    testid として残した**（1 表の testid が `共有中` / `共有していない` / すべて で切り替わる）。
  'engineer-share-active-filters',
  'engineer-share-clear',
  'engineer-share-confirm-cancel',
  'engineer-share-confirm-submit',
  'engineer-share-denied',
  'engineer-share-error',
  'engineer-share-filter-available-by',
  'engineer-share-filter-q',
  'engineer-share-filter-shared',
  'engineer-share-filtered-empty',
  'engineer-share-filters',
  'engineer-share-lead',
  'engineer-share-ledger-empty',
  'engineer-share-list',
  'engineer-share-load-more',
  'engineer-share-load-more-error',
  ...
  'engineer-share-show-not-shared',
  ...
  // ✅ T-12-16: `S-006` セクション 5（凍結情報との差分。`engineer-proposal-sections.tsx`）。
  'engineer-snapshot-diff',
  'engineer-snapshot-diff-careers',
  'engineer-snapshot-diff-careers-current',
  'engineer-snapshot-diff-careers-current-empty',
  'engineer-snapshot-diff-careers-current-table',
  'engineer-snapshot-diff-careers-frozen',
  'engineer-snapshot-diff-careers-frozen-empty',
  'engineer-snapshot-diff-careers-frozen-table',
  'engineer-snapshot-diff-careers-lead',
  'engineer-snapshot-diff-careers-note',
  'engineer-snapshot-diff-fields',
  'engineer-snapshot-diff-lead',
  'engineer-snapshot-diff-title',
  'engineer-snapshot-diff-unavailable',
  'engineer-submit',
...
const FROZEN_PREFIXES: readonly string[] = [
  ...
  'engineer-list-row-',
  // ✅ T-12-16: `S-006` セクション 4（提案履歴）の行と導線（提案 ID ごと）。
  'engineer-proposal-detail-link-',
  ...
  'engineer-share-state-',
  'engineer-skill-level-',
  'engineer-skill-remove-',
  'engineer-skill-row-',
  'engineer-skill-years-',
  // ✅ T-12-16: `S-006` セクション 5 の動的 testid（項目キー / 凍結行の位置キー / 台帳の行 ID）。
  'engineer-snapshot-diff-current-',
  'engineer-snapshot-diff-current-career-',
  'engineer-snapshot-diff-field-',
  'engineer-snapshot-diff-frozen-',
  'engineer-snapshot-diff-frozen-career-',
  'engineer-snapshot-diff-note-',
